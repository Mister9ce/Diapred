...
# Model building with PCA for feature selection
...
This web app allows you to predict whether a compound will activate the GLP-1 Receptor.
""")
...
if uploaded_file is not None:
    ...
    smiles_input = '\n'.join(smiles_list)  # Set the input content to smiles_input
    # Write content to molecule.smi without quotations and each SMILES index on a new line
    ...
    smiles_input = st.sidebar.text_area("Paste SMILES data here", example_smiles, height=200)
      # Set the default SMILES input to smiles_input
